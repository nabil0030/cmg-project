...
import com.cmg.back.repository.ExpPbCmgOnfRepository;
...
@Service
public class ExpPbCmgOnfService {
    @Autowired
    private ExpPbCmgOnfRepository repository;

    public List<ExpPbCmgOnf> findAll() { return repository.findAll(); }

    public Optional<ExpPbCmgOnf> findById(Long id) { return repository.findById(id); }

    public ExpPbCmgOnf save(ExpPbCmgOnf entry) {
    ...
    public ExpPbCmgOnf update(Long id, ExpPbCmgOnf entry) {
