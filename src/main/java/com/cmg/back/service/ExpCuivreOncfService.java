...
import com.cmg.back.repository.ExpCuivreOncfRepository;
...
@Service
public class ExpCuivreOncfService {
    @Autowired
    private ExpCuivreOncfRepository repository;

    public List<ExpCuivreOncf> findAll() { return repository.findAll(); }

    public Optional<ExpCuivreOncf> findById(Long id) { return repository.findById(id); }

    public ExpCuivreOncf save(ExpCuivreOncf entry) {
    ...
    public ExpCuivreOncf update(Long id, ExpCuivreOncf entry) {
